...
from alice import rishabh
from alice.modules.no_sql import AsuXdb as db
from alice.utils.pluginhelp import member_permissions
...
@rishabh.on_message(filters.command("unpinall") & ~filters.private)
...
@rishabh.on_message(filters.command("antichannelpin") & ~filters.private)
...
@rishabh.on_message(filters.command("cleanlinked") & ~filters.private)
...
@rishabh.on_message(filters.command("permapin") & ~filters.private)
...
@rishabh.on_message(filters.linked_channel)
