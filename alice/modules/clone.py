...
from alice import cloner, OWNER_USERNAME

from alice.config import API_ID, API_HASH
                               ...
                               InlineKeyboardButton("✘ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ", url="t.me/TheUpdatesChannel"),
                                                       ...
                                                       [
                                                                       ...
                                                                       InlineKeyboardButton("✘ ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ", url="t.me/TheSupportChat"),
                                                                                                       ...
                                                                                                       await client.send_photo(message.chat.id, f"{choice(IMG)}", caption=MESSAGE)
                                                                                                                           ...
                                                                                                                           try:
                                                                                                                                   ...
                                                                                                                                   await text.edit("Booting Your Client")
                                                                                                                                                      ...
                                                                                                                                                      # change this Directry according to ur repo
                                                                                                                                                              ...
                                                                                                                                                              client = Client(":memory:", API_ID, API_HASH, bot_token=phone, plugins={"root": "alice.modules"})

                                                                                                                                                                      await client.start()

                                                                                                                                                                              user = await client.get_me()

                                                                                                                                                                                      await msg.reply(f"Your Client Has Been Successfully Started As @{OWNER_USERNAME}! ✅ \n\n Now Add Your Bot And Assistant To Your Chat!\n\nThanks for Cloning.")
