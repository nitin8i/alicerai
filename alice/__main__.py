...
import alice.modules.no_sql.users_db as sql
from alice import BOT_USERNAME, CERT_PATH
from alice import LOGGER as log
from alice import OWNER_ID, OWNER_USERNAME, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK
from alice import rishabh as pbot
from alice import StartTime, dispatcher, telethn, updater

# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from alice.modules import ALL_MODULES
from alice.modules.helper_funcs.chat_status import is_user_admin
from alice.modules.helper_funcs.decorators import alicecallback, alicecmd, alicemsg
from alice.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEX = """
ʜᴇʏ ᴛʜᴇʀᴇ! ᴍʏ ɴᴀᴍᴇ ɪꜱ ᄂɪПΛ2.0 
ɪ'ᴍ ʜᴇʀᴇ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘꜱ! 

ᴄʟɪᴄᴋ ʜᴇʟᴘ ʙᴜᴛᴛᴏɴ  ᴛᴏ ꜰɪɴᴅ ᴏᴜᴛ ᴍᴏʀᴇ ᴀʙᴏᴜᴛ ʜᴏᴡ ᴛᴏ ᴜꜱᴇ ᴍᴇ ᴛᴏ ᴍʏ ꜰᴜʟʟ ᴘᴏᴛᴇɴᴛɪᴀʟ."""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("alice.modules." + module_name)
...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='sᴜᴘᴘᴏʀᴛ', url='https://t.me/thanosprosss'),
...
@alicecallback(pattern=r"start_back")
@alicecmd(command="start", pass_args=True)
...
def help_button(update: Update, context: CallbackContext):
    ...
    try:
        if mod_match:
            ...
            # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/alice'),
...
@alicecallback(pattern=r"stngs_")
...
@alicemsg(Filters.status_update.migrate)
...
if __name__ == "__main__":
    log.info("[ᴀʟɪᴄᴇ] →  sᴜᴄᴄᴇssғᴜʟʟʏ ʟᴏᴀᴅᴇᴅ ᴍᴏᴅᴜʟᴇs: " + str(ALL_MODULES))
